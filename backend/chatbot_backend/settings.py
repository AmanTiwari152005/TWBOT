...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY') or os.getenv('SECRET_KEY', 'replace-me-in-production')
DEBUG = (os.getenv('DEBUG') or os.getenv('DJANGO_DEBUG', 'False')).lower() == 'true'

ALLOWED_HOSTS = [
    host.strip()
    for host in (os.getenv('ALLOWED_HOSTS') or os.getenv('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1')).split(',')
    if host.strip()
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PARSER_CLASSES': [
        ...
        'chat.parsers.PlainTextJSONParser',
    ],
}
